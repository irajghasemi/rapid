...
// Then in the controllers you can add : @ResponseStatus(value = HttpStatus.NO_CONTENT),@ResponseStatus(HttpStatus.CREATED) or @ResponseBody
// to every controller methods to get a response. Like the example below:
