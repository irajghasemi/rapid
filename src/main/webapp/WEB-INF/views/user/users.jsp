...
<!--   <li><a href="http://localhost:8080/rapid/signup">Sign Up</a></li> -->
  <li><a href="http://localhost:8080/rapid/changePassword">ChangePassword</a></li>
 ...
 <div id='main' >
	...
	<div id="table">
	    ...
	    <span class="cell">Person Number</span>
	  ...
	  <div class="row">
	    ...
	    <span class="cell primary" data-label="Vehicle">${user.firstname}</span>
	    <span class="cell" data-label="Exterior">${user.surname}</span>
	     <span class="cell" data-label="Interior">${user.email}</span>
	     <span class="cell" data-label="Engine">${user.ssn}</span>
	     <span class="cell" data-label="Engine"><a href="">Edit</a></span>
	     <span class="cell" data-label="Engine"><a href="">Delete</a></span>
	  </div>
	  </c:forEach>
	</div>
