...
<body>
 ...
 <div id='main' >
    ...
    <article >
<div align="center">
			<form action="updateUser?ssn=${getuserforupdate.ssn}" method="post" modelAttribute="user" autocomplete="off">
			    <ul class="errorMessages"></ul>
			<h1>Edit Profile</h1>
			<input type="text" name="firstname" value="${getuserforupdate.firstname}" required>
			<input type="text" name="surname" value="${getuserforupdate.surname}" required>
			<input type="text" name="username" value="${getuserforupdate.username}" required>
<%-- 			<input type="password" name="password" value="${getuserforupdate.password}" required onfocus="value=''"> --%>
			<input type="email" name="email" value="${getuserforupdate.email}"required="required" >
    <div class="buttons">
        <button type="submit" value="Submit" class="btn">Save Edit</button>
    </div>
