...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/flex/css/buttons.css" media="screen" type="text/css" />
...
<article >
    <div style="clear:left; height:50px;"></div>
      <h4>Your password has been send to your email address, please check your email.</h4>
				...
				<br />
				<div align="left">
					Will bee redirect to log in page after 5 seconds. <br />Please
					login with your new password
				</div>
				<br />
					<button class="button blue medium " type="submit" onClick="location.href='/rapid'" >Back To Login</button>
</article>
